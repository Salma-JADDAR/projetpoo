...
$pro3= new ProUser("hind", "hindddd@gmail.com", "hind123", "Bio hind", "hind.png",12,"2026-01-01", "2027-01-01");
$users = [$basic, $pro, $moderator, $admin,$pro1,$pro2,$pro3];
...
if ($role === 'Basic') {
    ...
    $user->setUploadCountMensuel($currentUploads + 8); 
